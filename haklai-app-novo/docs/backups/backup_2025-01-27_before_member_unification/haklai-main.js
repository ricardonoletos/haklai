...
(function($) {
    ...
    class HaklaiApp {
        ...
        /**
         * Upload de imagem com compressão inteligente
         */
        uploadImage(file, callback) {
            ...
            // Compressa imagem se necessário
            this.compressImage(file)
                .then(compressedFile => {
                    this.uploadCompressedImage(compressedFile, callback);
                })
                .catch(error => {
         ...
         */
        uploadCompressedImage(file, callback) {
